...
| 硬件型号 | Wi-Fi 标准 | 频宽支持 | MIMO | 最高理论速率 |
| -------- | ---------- | -------- | ---- | ------------ |
| K2T      | Wi-Fi 5    | 80       | 2x2  | 867          |

### Clients

- [Apple 设备无线局域网和以太网技术规格](https://support.apple.com/zh-cn/guide/deployment/dep268652e6c/web)

| 设备名称          | 网卡型号                                                     | Wi-Fi 标准 | 最高频宽 | 空间流 |
| ----------------- | ------------------------------------------------------------ | ---------- | -------- | ------ |
